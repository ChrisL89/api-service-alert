...
local-test:
	...
	docker-compose -f docker-compose.yaml run --rm api-service-alert npm run test
	docker-compose -f docker-compose.yaml down --remove-orphans
...
ci-test:
	...
	docker-compose -f docker-compose.yaml run --rm api-service-alert npm run test:ci
	docker-compose -f docker-compose.yaml down --remove-orphans
